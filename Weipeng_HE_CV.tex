...
\begin{itemize}[nosep]
  ...
  \item Conducted an exploratory research project on audio magic eraser which separates individual sounds from mixtures based on sound classes, enabling suppressing or enhancing specific sounds in videos.
  \item Mentored two interns in their research projects on multi-channel sound separation and audio-visual noise suppression, guiding them through experimental design, data analysis, and manuscript preparation, resulting in peer-reviewed publications and submissions.
\end{itemize}
