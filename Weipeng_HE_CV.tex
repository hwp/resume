...
Learning-based Multi-microphone Acoustic Signal Processing $\cdotp$ Sound Source Localization \\
Robot Audition $\cdotp$ Machine Learning
...
\begin{itemize}
  \item \textbf{Joint Localization and Classification of Multiple Sound Sources Using a Multi-task Neural Network.}
    ...
    (\textbf{nominated for a best student paper award})
