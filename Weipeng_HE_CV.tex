...
\textbf{Machine Learning Engineer} \hfill June 2025 --- Present \\
Jane Street  \hfill New York, NY \\
\vspace{-1.5\parskip}

Developed and maintained high-performance machine learning infrastructure to support large-scale model training and inference. 
\vspace{-.9\parskip}
\begin{itemize}[nosep]
  \item Designed scalable data pipelines, optimized distributed training workflows, and improved system throughput and resource utilization. 
  \item Implemented monitoring, logging, and automated deployment processes to ensure reliability, reproducibility, and efficient experimentation across environments.
\end{itemize}
