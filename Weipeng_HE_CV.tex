...
\vspace{-\parskip}
\begin{itemize}
  \item Developed nature language processing platform for automatic market information retrieval system.
\end{itemize}
...
\vspace{-\parskip}
\begin{itemize}
  \item Studied interative object recognition for robots with audio-visual sensory fusion.
