...
{\LARGE\bfseries\sffamily Speech \& Audio Research Scientist} \\[4pt]
%
\ifcase\version
...
\textbf{Research Scientist} \hfill September 2021 --- Present \\
...
\begin{itemize}[nosep]
  ...
  \item Pioneered the development of multi-channel end-to-end wake word detection models for smart glasses, removing dependency to traditional audio DSP front-end and reducing false rejection rate by 13\% in noisy conditions. Optimized overall system efficiency, resulting in a 30-minute increase in device battery life.
  ...
  \item Led an exploratory research project to design and prototype an audio ``magic eraser'' model, enabling selective suppression or enhancement of specific sounds in videos by separating individual sounds from mixtures based on sound classes.
  ...
  \item Mentored an intern on a research project focused on multi-channel sound separation leveraging spatial information from microphone array used in cocktail party environments.
  \item Led the implementation of automated data preprocessing and augmentation pipeline for noise suppression and wake word detection model development, reducing manual effort by 90\%.
\end{itemize}
...
\vspace{-.9\parskip}
\begin{itemize}[nosep]
  \item Developed deep learning-based sound source localization models for the Pepper robot in noisy multi-talker environments, achieving over 90\% precision and recall for real-time detection and localization of multiple simultaneous sounds sources. [\href{https://www.youtube.com/watch?v=_4EwuVlE_pU}{video demo}]
  ...
  \item Innovated data augmentation and weakly-supervised domain adaptation methods for low-resource training of sound source localization neural networks, enabling development of accurate sound source location models using training data without complete location labels.
\end{itemize}
...
\begin{itemize}[nosep]
  ...
  \item Innovated a spatial attention module for factorized complex linear projection models, reducing computational cost and improving recognition rate (reduced word error rate by 9\%).
\end{itemize}
