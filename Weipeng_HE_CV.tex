...
\section{Experiences}
\begin{tabular}{R{3.5cm}|p{11cm}}	
  \textsc{Oct 2012} - Present & Research Assistant at \textsc{Technical Aspects of Multimodal Systems Group}, University of Hamburg \\
  & Advisor: Prof. Dr. Jianwei \textsc{Zhang} \\
  & {\footnotesize Implemented a \textit{visual-audio object recognition} system based on \textit{hidden Markov models}. (Master thesis in progress, a \hyperlink{synopsis}{synopsis} is attached)} \\
...
%------------------------------------------------
  ...
  \textsc{Feb 2012 - Jul 2012} & Research Assistant at \textsc{Intelligent Information Acquisition Group}, Tsinghua University \\
  & Advisor: Prof. Xiaoyan \textsc{Zhu} \\
  & {\footnotesize Implemented a \textit{dialog system} with reinforcement learning.} \\
  \multicolumn{2}{c}{} \\

%------------------------------------------------

  \textsc{Apr 2010 - Jan 2012} & Research Assistant at \textsc{Nature Language Processing Group}, Tsinghua University \\
...
\begin{tabular}{rl}
  \textsc{Oct 2013 - Mar 2015} & \textbf{Merit Scholarship for International Student}, {\small University of Hamburg}. \\
...
Title: Visual-Audio Object Recognition using Hidden Markov Models
