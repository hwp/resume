...
\begin{center}
  ...
  \url{www.linkedin.com/in/hwp0} $\cdotp$
...
\begin{center}
  ...
  $\cdotp$ Speech Enhancement $\cdotp$ Microphone Array Processing $\cdotp$ Sound Event Detection
  $\cdotp$ Sound Source Localization $\cdotp$ Audio DSP
\end{center}
...
\begin{itemize}
  ...
  \item Deployed light-weight speech enhancement model to DSP on smart glasses. Reduced computational cost by 30\% by quantization and computational graph optimization techniques.
  \item Built multi-channel end-to-end wake word detection models to DSP on smart glasses with improved noise robustness. Optimized model computational cost and increased device battery life by 30 minutes.
\end{itemize}
...
\begin{itemize}
  \item Developed deep learning-based sound source localization models for human-robot interactions.
        Achieved more than 90\% precision and recall for detecting and localizing multiple simultaneous sources in real-time.
...
\vspace{-.9\parskip}
\begin{itemize}
  \item Developed deep beamforming neural networks for far-field automatic speech recognition on smart speakers.
        Reduced word error rate by 9\% by using the proposed spatial attention.
\end{itemize}
...
% Interests: & Classical guitar, snowboarding, sailing \\
\end{tabular}
